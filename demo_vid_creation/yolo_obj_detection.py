...
'''
    ...
    #img_frame, detections = yolo_obj_detection.detect_objects(img, net, output_layers, classes)
    
    #yolo_obj_detection.extract_info_from_frames(folder_path, net, output_layers, classes)
